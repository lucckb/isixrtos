...
static __IO USB_OTG_DCTL_TypeDef SET_TEST_MODE;
...
{
	SET_TEST_MODE = *test_val;
}

static const USBD_DCD_INT_cb_TypeDef * const USBD_DCD_INT_fops = &USBD_DCD_INT_cb;


const USBD_DCD_INT_cb_TypeDef * USBD_Get_Device_INT_fops(void)
{
	return USBD_DCD_INT_fops;
}
