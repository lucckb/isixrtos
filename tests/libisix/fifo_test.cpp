...
void fifo_test::base_tests() 
{
	...
	task_test* t1 = new task_test( 'A',  3, fifo_tst );
	task_test* t2 = new task_test( 'B',  2, fifo_tst );
	task_test* t3 = new task_test( 'C',  1, fifo_tst );
	task_test* t4 = new task_test( 'D',  0, fifo_tst );
	/*	
