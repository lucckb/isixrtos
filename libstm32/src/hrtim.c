#include <stm32lib.h>
#include <stm32hrtim.h>
#include <stm32rcc.h>
#ifdef RCC_APB2Periph_HRTIM1
/** STM32F3 hrtim driver from STM32 MICRO */
...
static const uint32_t TimerIdxToTimerId[] =
{
...
void HRTIM_DeInit(HRTIM_TypeDef* HRTIMx)
{
	(void)HRTIMx;
	/* Check the parameters */
	rcc_apb2_periph_reset_cmd(RCC_APB2Periph_HRTIM1, ENABLE);
	rcc_apb2_periph_reset_cmd(RCC_APB2Periph_HRTIM1, DISABLE);
}
