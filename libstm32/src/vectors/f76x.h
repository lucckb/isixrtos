...
ISR_VECTOR(usart7_isr_vector);
ISR_VECTOR(usart8_isr_vector);
ISR_VECTOR(spi4_isr_vector);
ISR_VECTOR(spi5_isr_vector);
ISR_VECTOR(spi6_isr_vector);
ISR_VECTOR(sai1_isr_vector);
ISR_VECTOR(ltdc_isr_vector);
ISR_VECTOR(ltdc_er_isr_vector);
ISR_VECTOR(dma2d_isr_vector);
ISR_VECTOR(sai2_isr_vector);
ISR_VECTOR(quadspi_isr_vector);
ISR_VECTOR(lptim1_isr_vector);
ISR_VECTOR(cec_isr_vector);
ISR_VECTOR(i2c4_ev_isr_vector);
ISR_VECTOR(i2c4_er_isr_vector);
ISR_VECTOR(spdif_rx_isr_vector);
ISR_VECTOR(dfsdm1_flt0_isr_vector);
ISR_VECTOR(dfsdm1_flt1_isr_vector);
ISR_VECTOR(dfsdm1_flt2_isr_vector);
ISR_VECTOR(dfsdm1_flt3_isr_vector);
ISR_VECTOR(sdio2_isr_vector);
ISR_VECTOR(can3_tx_isr_vector);
ISR_VECTOR(can3_rx0_isr_vector);
ISR_VECTOR(can3_rx1_isr_vector);
...
const vect_fun_t _exceptions_vectors[] =
{
  ...
  spdif_rx_isr_vector,
  0,
  dfsdm1_flt0_isr_vector,
  dfsdm1_flt1_isr_vector,
  dfsdm1_flt2_isr_vector,
  dfsdm1_flt3_isr_vector,
  sdio2_isr_vector,
  can3_tx_isr_vector,
  can3_rx0_isr_vector,
  can3_rx1_isr_vector,
