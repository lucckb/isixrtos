/*
 * sdcard_driver_common.h
 *
 *  Created on: 27-11-2012
 *      Author: lucck
 */

#ifndef ISIXDRV_SDCARD_DRIVER_COMMON_H_
#define ISIXDRV_SDCARD_DRIVER_COMMON_H_
/* ------------------------------------------------------------------ */
#include <stdint.h>
#include <stddef.h>
#include <stdbool.h>
...
/**
  ...
  */
  ...
  SD_UNSUPPORTED_HW,
  SD_ERROR,
  SD_LIB_NOT_INITIALIZED,
  SD_LIB_ALREADY_INITIALIZED,
  SD_OK = 0
} sdcard_err;
