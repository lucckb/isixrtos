...
ISIXDRV_CPPSRC += $(ISIXDRV_DIR)/mmc/mmc_card.cpp $(ISIXDRV_DIR)/mmc/mmc_host.cpp $(ISIXDRV_DIR)/stm32_spi_master.cpp 
ISIXDRV_CPPSRC += $(ISIXDRV_DIR)/mmc/mmc_host_spi.cpp
