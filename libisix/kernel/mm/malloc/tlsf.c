...
/*
 * Code contributions:
 * (Jun 19 2017)  Lucjan Bryndza Isix optimizations <lbryndza.p@boff.pl>
...
static __inline__ int ls_bit(unsigned int x);
static __inline__ int ms_bit(unsigned int x);
...
/******************************************************************/
    ...
    tlsf->area_head = (void *) ib->ptr.buffer;
