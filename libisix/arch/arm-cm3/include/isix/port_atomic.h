...
void port_atomic_sem_init( _port_atomic_t* lock, int value , int limit ) {
 ...
 */
static inline __attribute__((always_inline))
int port_atomic_sem_dec( _port_atomic_t* lock ) {
 ...
 */
static inline __attribute__((always_inline))
int port_atomic_sem_inc( _port_atomic_t* lock ) {
 ...
 * @return readed value*/
static inline __attribute__((always_inline))
long port_atomic_sem_read_val( _port_atomic_t* lock ) 
{
 ...
 */
static inline __attribute__((always_inline))
int port_atomic_sem_write_val( _port_atomic_t* lock, int val )
{
...
/** Wait for interrupt */
static inline __attribute__((always_inline))
void port_atomic_wait_for_interrupt()
{
