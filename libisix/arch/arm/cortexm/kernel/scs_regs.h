 ...
 *
 *    Description:  System control Block memmap
 *
 *        Version:  1.0
 *        Created:  15.04.2017 19:29:32
 *       Revision:  none
 *       Compiler:  gcc
 *
 * =====================================================================================
...
#define SCS_SYST_CSR_ENABLE			(1U<<0)
/* Count to 0 changes the SysTick exception status to pending. */
#define SCS_SYST_CSR_TICKINT		(1U<<1)
/* SysTick uses the processor clock. */
#define SCS_SYST_CSR_CLKSOURCE		(1U<<2)
/*
 ...
 */
#define SCS_SYST_CSR_COUNTFLAG		(1U<<16)
 ...
 */
#define SCS_SYST_SYST_CALIB_TENMS_MASK		((1U<<24)-1)
 ...
 */
#define SCS_SYST_SYST_CALIB_VALUE_INEXACT	(1U<<30)
/*
 ...
 */
#define SCS_SYST_SYST_CALIB_REF_NOT_IMPLEMENTED	(1U<<31)
